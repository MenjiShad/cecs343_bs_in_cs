 ...
 *
 * Cards that reward players with a chip of choice
 * 	11
 * 	12
 * 	24
 *  26
 ...
 *  37
 *  
 * Cards that reward players with a card(s)
 * 	25
 * 	30
 *  31
 *  33
 * 
 * Cards that punish players by discarding a game card of their choice
 * 	8
 * 	10
 * 	17
 * 	24
